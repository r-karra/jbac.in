...
CHRISTIAN_BOOKS_API_URL = os.getenv("CHRISTIAN_BOOKS_API_URL", "https://gutendex.com/books")
CHRISTIAN_BOOKS_DEFAULT_QUERY = os.getenv("CHRISTIAN_BOOKS_DEFAULT_QUERY", "christianity")
CHRISTIAN_BOOKS_MAX_RESULTS = int(os.getenv("CHRISTIAN_BOOKS_MAX_RESULTS", "36"))
