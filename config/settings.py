...
CHRISTIAN_BOOKS_API_URL = os.getenv("CHRISTIAN_BOOKS_API_URL", "https://www.googleapis.com/books/v1/volumes")
CHRISTIAN_BOOKS_DEFAULT_QUERY = os.getenv("CHRISTIAN_BOOKS_DEFAULT_QUERY", "subject:Christianity")
CHRISTIAN_BOOKS_MAX_RESULTS = int(os.getenv("CHRISTIAN_BOOKS_MAX_RESULTS", "30"))
